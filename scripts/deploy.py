...
def main():
    ...
    if network.show_active() in ["mainnet-fork-dev", "kovan"]:
        weth()
...
def get_asset_price(price_feed_address):
    ...
    # fromWei or toWei convert the value into proper eth
